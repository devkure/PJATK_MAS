...
public class Programmer extends TeamMember {
    ...
    public Programmer(PersonalData personalData, String nName, String email, String role, String specialization, ArrayList<String> technologies) throws ValidationException {
