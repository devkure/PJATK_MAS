...
abstract class Artist extends TeamMember {
    private String specialization;
    private ArrayList<String> software;

    public Artist(PersonalData personalData, String nName, String email, String role, String specialization, ArrayList<String> software, SeniorityLevel seniorityLevel, AccessLevel accessLevel) throws ValidationException {
